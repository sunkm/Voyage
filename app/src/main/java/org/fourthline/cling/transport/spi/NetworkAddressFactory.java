...
public interface NetworkAddressFactory {
    ...
    String SYSTEM_PROPERTY_NET_IFACES = "org.fourthline.cling.network.useInterfaces";
    String SYSTEM_PROPERTY_NET_ADDRESSES = "org.fourthline.cling.network.useAddresses";
