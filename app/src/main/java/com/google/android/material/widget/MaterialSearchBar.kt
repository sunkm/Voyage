...
import com.manchuan.tools.databinding.MaterialSearchBarBinding
...
class MaterialSearchBar @JvmOverloads constructor(
    ...
    init {
        ...
        when {
            a?.hasValue(R.styleable.MaterialSearchBar_search_navigationIconCompat)!! -> {
                navigationIconCompat =
                    a?.getInt(R.styleable.MaterialSearchBar_search_navigationIconCompat,
        ...
        if (a?.hasValue(R.styleable.MaterialSearchBar_search_navigationElevation)!!) {
            val navigationElevation =
                a?.getDimensionPixelSize(R.styleable.MaterialSearchBar_search_navigationElevation,
                    0)
    ...
    override fun onAttachedToWindow() {
        ...
        val defaultMarginsStartEnd = context.resources.getDimensionPixelSize(R.dimen.dp_16)
        val defaultMarginsTopBottom = context.resources.getDimensionPixelSize(R.dimen.dp_8)

        val customMarginsStart =
            a?.getDimensionPixelSize(R.styleable.MaterialSearchBar_android_layout_marginStart,
                defaultMarginsStartEnd)!!
        val customMarginsEnd =
            a?.getDimensionPixelSize(R.styleable.MaterialSearchBar_android_layout_marginEnd,
                defaultMarginsStartEnd)!!
        val customMarginsTop =
            a?.getDimensionPixelSize(R.styleable.MaterialSearchBar_android_layout_marginTop,
                defaultMarginsTopBottom)!!
        val customMarginsBottom =
            a?.getDimensionPixelSize(R.styleable.MaterialSearchBar_android_layout_marginBottom,
                defaultMarginsTopBottom)!!
