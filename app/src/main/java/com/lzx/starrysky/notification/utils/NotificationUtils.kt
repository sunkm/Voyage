...
//        openUI.flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
        ...
        //构建 PendingIntent
        @SuppressLint("WrongConstant") val pendingIntent: PendingIntent
        val requestCode = INotification.REQUEST_CODE
        val flags = if (Build.VERSION.SDK_INT >= 31) PendingIntent.FLAG_IMMUTABLE else PendingIntent.FLAG_CANCEL_CURRENT
    ...
    fun createNoCrashNotification(context: Context): Notification {
        ...
        return notifyBuilder.setContentTitle("防止崩溃通知").setSmallIcon(R.drawable.ic_notification)
            .build()
