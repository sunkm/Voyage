...
data class TencentLoginModel(var succeed: Boolean, var response: QQLogin?)

data class QQLogin(
    val ret: Int, val openid: String, val access_token: String,
...
data class QQInfo(
    val ret: Int, val msg: String, val is_lost: Int, val nickname: String,
