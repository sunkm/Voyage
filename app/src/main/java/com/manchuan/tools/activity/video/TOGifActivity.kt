...
class TOGifActivity : AppCompatActivity() {
    ...
    private fun video2Gif() {
        val targetPath =
            com.manchuan.tools.extensions.externalPicturesDirPath + File.separator + "${SystemClock.elapsedRealtime()}.gif"
        GlobalScope.launch {
            FFmpegCommand.runCmd(FFmpegUtils.video2Gif(path,
                0,
                binding.time.textString.toInt(),
