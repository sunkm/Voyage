...
package com.manchuan.tools.eggs.t.neko;
...
public class NekoService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        Timber.tag(TAG).v("Starting job: %s", String.valueOf(params));
    ...
    public static void registerJob(Context context, long intervalMinutes) {
        ...
        @SuppressLint("JobSchedulerService") final JobInfo jobInfo = new JobInfo.Builder(JOB_ID,
