...
import com.manchuan.tools.databinding.FragmentGameFcBinding
...
class GameFCFragment : EngineFragment<FragmentGameFcBinding>(R.layout.fragment_game_fc) {
    ...
    override fun initView() {
        ...
        receiveEvent<ArrayList<GameModel>>("models_fc") {
            binding.recyclerView.models = it
        }
        receiveEvent<ArrayList<GameModel>>("load_more_models_fc") {
        ...
        binding.page.onRefresh {
            ...
            Thread {
                runCatching {
                    gameList.clear()
                    val document =
                        Jsoup.connect("https://www.yikm.net/nes?page=$page&tag=0&e=0").get()
        ...
        binding.page.onLoadMore {
            Thread {
                runCatching {
                    ...
                    sendEvent(gameList, "load_more_models_fc")
                    page++
                    this.finish(true)
                }.onFailure {
                    this.finish(false)
