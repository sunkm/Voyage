...
import com.manchuan.tools.databinding.FragmentGameMdBinding
...
class GameMDFragment : EngineFragment<FragmentGameMdBinding>(R.layout.fragment_game_md) {
    ...
    override fun initView() {
        ...
        receiveEvent<ArrayList<GameModel>>("models_md") {
            binding.recyclerView.models = it
        }
        receiveEvent<ArrayList<GameModel>>("load_more_models_md") {
        ...
        binding.page.onRefresh {
            ...
            Thread {
                runCatching {
                    gameList.clear()
                    val document =
                        Jsoup.connect("https://www.yikm.net/nes?page=$page&tag=&e=3").get()
        ...
        binding.page.onLoadMore {
            Thread {
                runCatching {
                    ...
                    sendEvent(gameList, "load_more_models_md")
                    page++
                    this.finish(true)
                }.onFailure {
                    this.finish(false)
