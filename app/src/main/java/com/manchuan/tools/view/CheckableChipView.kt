...
import com.manchuan.tools.extensions.lerp
import com.manchuan.tools.extensions.textWidth
...
class CheckableChipView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Outline
        if (progress < 1f) {
            canvas.drawRoundRect(halfStroke,
                halfStroke,
                width - halfStroke,
                height - halfStroke,
                rounding,
        ...
        val indicatorSize = lerp(initialIndicatorSize,
        ...
        canvas.drawRoundRect(indicatorCenterX - indicatorSizeHalf,
        ...
        // Text
        val textX = lerp(indicatorCenterX + initialIndicatorSize / 2f + padding,
        ...
        // Clear icon
        if (progress > 0f) {
            canvas.withTranslation(x = width - outlineWidth - padding - iconRadius,
                y = height / 2f) {
