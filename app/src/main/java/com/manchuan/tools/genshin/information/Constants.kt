...
class Constants {
    companion object {
        ...
        const val SIGN_APP_VERSION = "2.28.1"
        ...
        //角色和武器的更新URL
        const val PAIMONS_NOTEBOOK_WEB = "https://qoolianyi.github.io/github.io/"

        //未来更新计划
        const val PAIMONSNOTEBOOK_UPDATE_PLAN_URL =
            "https://github.com/QooLianyi/github.io/blob/main/PaimonsNotebookUpdateProject.md"

        const val PAIMONS_NOTE_BOOK_LATEST =
        ...
        const val HTML_SELECTOR_PAIMONS_NOTE_BOOK_APP_LASTEST_VERSION_CODE =
            "p.app_last_version_code"

        //旅行者札记饼图颜色
        val monthLegendColors = listOf(
            ContextCompat.getColor(context, R.color.abyss_fill),
            ContextCompat.getColor(context, R.color.daily_fill),
            ContextCompat.getColor(context, R.color.event_fill),
            ContextCompat.getColor(context, R.color.mail_fill),
            ContextCompat.getColor(context, R.color.adventure_fill),
            ContextCompat.getColor(context, R.color.task_fill),
            ContextCompat.getColor(context, R.color.other_fill)
        )
