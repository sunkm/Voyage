...
open class WebActivity : TitleBarActivity() {
    ...
    private val mStatusBarColor: Int by lazy { intent.getIntExtra("statusBarColor", -1) }
    private val hideTitleBar: Boolean by lazy { intent.getBooleanExtra("hideTitleBar", false) }
