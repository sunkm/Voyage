...
open class FormField @JvmOverloads constructor(
    ...
    init {
        ...
        mInputTextSize =
            ta.getDimensionPixelSize(R.styleable.FormField_ff_inputTextSize, mInputTextSize)
        ...
        mFieldTextSize =
            ta.getDimensionPixelSize(R.styleable.FormField_ff_fieldTextSize, mFieldTextSize)
    ...
    fun setupSelf(
        ...
        fieldTextSize: Int? = null,
        fieldTextColor: Int? = null,
        fieldTextBold: Boolean? = null,
        hint: String? = null,
        hintColor: Int? = null,
        inputText: String? = null,
        inputTextSize: Int? = null,
        inputTextColor: Int? = null,
        inputMaxLines: Int? = null,
