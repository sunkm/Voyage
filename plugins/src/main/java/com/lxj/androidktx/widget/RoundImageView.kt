...
class RoundImageView @JvmOverloads constructor(
    ...
    init {
        val ta = context.obtainStyledAttributes(attrs, R.styleable.RoundImageView, 0, 0)
    ...
    fun setTopLeftRadius(cornerTopLeftRadius: Int) {
        this.cornerTopLeftRadius = cornerTopLeftRadius
        calculateRadiiAndRectF(true)
    }

    fun setTopRightRadius(cornerTopRightRadius: Int) {
        this.cornerTopRightRadius = cornerTopRightRadius
        calculateRadiiAndRectF(true)
    }

    fun setBottomLeftRadius(cornerBottomLeftRadius: Int) {
        this.cornerBottomLeftRadius = cornerBottomLeftRadius
        calculateRadiiAndRectF(true)
    }

    fun setBottomRightRadius(cornerBottomRightRadius: Int) {
