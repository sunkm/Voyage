...
class SlidingLayout @JvmOverloads constructor(
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        rightView?.layout(contentView!!.right,
            0,
            contentView!!.right + rightView!!.measuredWidth,
            measuredHeight)
    }
    ...
    val cb = object : ViewDragHelper.Callback() {
        ...
        override fun clampViewPositionHorizontal(child: View, left: Int, dx: Int): Int {
            ...
            if (child == contentView) {
                ...
                if (newLeft < (contentView!!.measuredWidth - rightView!!.measuredWidth)) newLeft =
                    contentView!!.measuredWidth - rightView!!.measuredWidth
