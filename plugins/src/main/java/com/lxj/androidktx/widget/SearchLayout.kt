...
open class SearchLayout @JvmOverloads constructor(
    ...
    init {
        ...
        clearIcon = ta.getDrawable(R.styleable.SearchLayout_sl_clearIcon)
            ?: drawable(R.drawable.ic_twotone_clear_24)
        searchIcon = ta.getDrawable(R.styleable.SearchLayout_sl_searchIcon)
            ?: drawable(R.drawable.ic_twotone_search_24)
        clearIconSize =
            ta.getDimensionPixelSize(R.styleable.SearchLayout_sl_clearIconSize, clearIconSize)
        searchIconSize =
            ta.getDimensionPixelSize(R.styleable.SearchLayout_sl_searchIconSize, searchIconSize)
        showClearIconWhenEmpty = ta.getBoolean(R.styleable.SearchLayout_sl_showClearIconWhenEmpty,
            showClearIconWhenEmpty)
        showSearchIcon = ta.getBoolean(R.styleable.SearchLayout_sl_showSearchIcon, showSearchIcon)
        searchIconPosition =
            ta.getInt(R.styleable.SearchLayout_sl_searchIconPosition, searchIconPosition)
        searchIconSpace =
